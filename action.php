				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
							...
							<input type="hidden" name="business" value="shoppingcart@Ecommerce-master.com">
							...
							echo   
								'<input type="hidden" name="return" value="http://3.208.161.114/project1/payment_success.php"/>
					                <input type="hidden" name="notify_url" value="http://3.208.161.114/Ecommerce-master/payment_success.php">
									<input type="hidden" name="cancel_return" value="http://3.208.161.114/Ecommerce-master/cancel.php"/>
